package  game.managers
{
    ...
    public class Depth3DMgr {
		 ...
		 * 
		 */		
        public static function getManager(container:DisplayObjectContainer):Depth3DMgr{
            if (!managers){
                managers = new Dictionary(true);
            };
            var m:Depth3DMgr = managers[container];
            if (!m){
                m = new Depth3DMgr();
